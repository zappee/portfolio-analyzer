...
public class SummaryGenerator {
     ...
     */
    public SummaryGenerator(List<Transaction> transactions, String portfolio, List<String> tickers) {
     ...
     */
    public Map<String, Map<String, Summary>> build() {
        Map<String, Map<String, Summary>> report = new HashMap<>();
        transactions
                .stream()
        ...
        new BookkeepingTransactionGenerator(transactions).updateBookkeepingTransactions(report);
        return report;
    }
     ...
     */
    private void addTransactionToReport(Map<String, Map<String, Summary>> report, Transaction transaction) {
     ...
     */
    private Summary getProductSummary(Map<String, Map<String, Summary>> report,
                                      String portfolio,
                                      String ticker) {

        var productSummaries = report.computeIfAbsent(portfolio, v -> new HashMap<>());
        return productSummaries.computeIfAbsent(ticker, v -> new Summary(portfolio, ticker));
    }
}
